...
$CreateOrderRespCopyWith<CreateOrderResp> get copyWith => _$CreateOrderRespCopyWithImpl<CreateOrderResp>(this as CreateOrderResp, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateOrderResp&&(identical(other.orderStr, orderStr) || other.orderStr == orderStr)&&(identical(other.orderId, orderId) || other.orderId == orderId)&&(identical(other.token, token) || other.token == token));
}
...
abstract mixin class $CreateOrderRespCopyWith<$Res>  {
  factory $CreateOrderRespCopyWith(CreateOrderResp value, $Res Function(CreateOrderResp) _then) = _$CreateOrderRespCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CreateOrderResp value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CreateOrderResp value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CreateOrderResp value)?  $default,){
final _that = this;
switch (_that) {
case _CreateOrderResp() when $default != null:
return $default(_that);case _:
...
class _CreateOrderResp implements CreateOrderResp {
  ...
  factory _CreateOrderResp.fromJson(Map<String, dynamic> json) => _$CreateOrderRespFromJson(json);
...
@pragma('vm:prefer-inline')
_$CreateOrderRespCopyWith<_CreateOrderResp> get copyWith => __$CreateOrderRespCopyWithImpl<_CreateOrderResp>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CreateOrderRespToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateOrderResp&&(identical(other.orderStr, orderStr) || other.orderStr == orderStr)&&(identical(other.orderId, orderId) || other.orderId == orderId)&&(identical(other.token, token) || other.token == token));
}
...
/// @nodoc
abstract mixin class _$CreateOrderRespCopyWith<$Res> implements $CreateOrderRespCopyWith<$Res> {
  factory _$CreateOrderRespCopyWith(_CreateOrderResp value, $Res Function(_CreateOrderResp) _then) = __$CreateOrderRespCopyWithImpl;
@override @useResult
$Res call({
 String? orderStr, String? orderId, String? token
});
