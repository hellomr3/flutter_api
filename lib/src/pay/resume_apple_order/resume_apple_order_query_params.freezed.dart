...
$ResumeAppleOrderQueryParamsCopyWith<ResumeAppleOrderQueryParams> get copyWith => _$ResumeAppleOrderQueryParamsCopyWithImpl<ResumeAppleOrderQueryParams>(this as ResumeAppleOrderQueryParams, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResumeAppleOrderQueryParams&&(identical(other.signedPayload, signedPayload) || other.signedPayload == signedPayload));
}
...
abstract mixin class $ResumeAppleOrderQueryParamsCopyWith<$Res>  {
  factory $ResumeAppleOrderQueryParamsCopyWith(ResumeAppleOrderQueryParams value, $Res Function(ResumeAppleOrderQueryParams) _then) = _$ResumeAppleOrderQueryParamsCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ResumeAppleOrderQueryParams value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ResumeAppleOrderQueryParams value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ResumeAppleOrderQueryParams value)?  $default,){
final _that = this;
switch (_that) {
case _ResumeAppleOrderQueryParams() when $default != null:
return $default(_that);case _:
...
class _ResumeAppleOrderQueryParams implements ResumeAppleOrderQueryParams {
  ...
  factory _ResumeAppleOrderQueryParams.fromJson(Map<String, dynamic> json) => _$ResumeAppleOrderQueryParamsFromJson(json);
...
@pragma('vm:prefer-inline')
_$ResumeAppleOrderQueryParamsCopyWith<_ResumeAppleOrderQueryParams> get copyWith => __$ResumeAppleOrderQueryParamsCopyWithImpl<_ResumeAppleOrderQueryParams>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ResumeAppleOrderQueryParamsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ResumeAppleOrderQueryParams&&(identical(other.signedPayload, signedPayload) || other.signedPayload == signedPayload));
}
...
/// @nodoc
abstract mixin class _$ResumeAppleOrderQueryParamsCopyWith<$Res> implements $ResumeAppleOrderQueryParamsCopyWith<$Res> {
  factory _$ResumeAppleOrderQueryParamsCopyWith(_ResumeAppleOrderQueryParams value, $Res Function(_ResumeAppleOrderQueryParams) _then) = __$ResumeAppleOrderQueryParamsCopyWithImpl;
@override @useResult
$Res call({
 String signedPayload
});
