...
$VerifyOrderStatusQueryParamsCopyWith<VerifyOrderStatusQueryParams> get copyWith => _$VerifyOrderStatusQueryParamsCopyWithImpl<VerifyOrderStatusQueryParams>(this as VerifyOrderStatusQueryParams, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerifyOrderStatusQueryParams&&(identical(other.orderId, orderId) || other.orderId == orderId));
}
...
abstract mixin class $VerifyOrderStatusQueryParamsCopyWith<$Res>  {
  factory $VerifyOrderStatusQueryParamsCopyWith(VerifyOrderStatusQueryParams value, $Res Function(VerifyOrderStatusQueryParams) _then) = _$VerifyOrderStatusQueryParamsCopyWithImpl;
@useResult
$Res call({
 String? orderId
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _VerifyOrderStatusQueryParams value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _VerifyOrderStatusQueryParams value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _VerifyOrderStatusQueryParams value)?  $default,){
final _that = this;
switch (_that) {
case _VerifyOrderStatusQueryParams() when $default != null:
return $default(_that);case _:
...
class _VerifyOrderStatusQueryParams implements VerifyOrderStatusQueryParams {
  ...
  factory _VerifyOrderStatusQueryParams.fromJson(Map<String, dynamic> json) => _$VerifyOrderStatusQueryParamsFromJson(json);
...
@pragma('vm:prefer-inline')
_$VerifyOrderStatusQueryParamsCopyWith<_VerifyOrderStatusQueryParams> get copyWith => __$VerifyOrderStatusQueryParamsCopyWithImpl<_VerifyOrderStatusQueryParams>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$VerifyOrderStatusQueryParamsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _VerifyOrderStatusQueryParams&&(identical(other.orderId, orderId) || other.orderId == orderId));
}
...
/// @nodoc
abstract mixin class _$VerifyOrderStatusQueryParamsCopyWith<$Res> implements $VerifyOrderStatusQueryParamsCopyWith<$Res> {
  factory _$VerifyOrderStatusQueryParamsCopyWith(_VerifyOrderStatusQueryParams value, $Res Function(_VerifyOrderStatusQueryParams) _then) = __$VerifyOrderStatusQueryParamsCopyWithImpl;
@override @useResult
$Res call({
 String? orderId
});
