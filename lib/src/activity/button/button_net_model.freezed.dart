...
mixin _$ButtonNetModel {
  ...
  /// 按钮行为类型 - 决定按钮点击后的行为
  ButtonActionType get actionType;
  ...
  $ButtonNetModelCopyWith<ButtonNetModel> get copyWith =>
      _$ButtonNetModelCopyWithImpl<ButtonNetModel>(
          this as ButtonNetModel, _$identity);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, text, type, actionType,
...
abstract mixin class $ButtonNetModelCopyWith<$Res> {
  factory $ButtonNetModelCopyWith(
          ButtonNetModel value, $Res Function(ButtonNetModel) _then) =
      _$ButtonNetModelCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String? text,
...
extension ButtonNetModelPatterns on ButtonNetModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ButtonNetModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String? text, ButtonType? type,
            ButtonActionType actionType, Map<String, String>? payload)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ButtonNetModel() when $default != null:
        return $default(
            _that.id, _that.text, _that.type, _that.actionType, _that.payload);
      case _:
        return orElse();
    }
  }
...
class _ButtonNetModel implements ButtonNetModel {
  const _ButtonNetModel(
      ...
      : _payload = payload;
  factory _ButtonNetModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ButtonNetModelCopyWith<_ButtonNetModel> get copyWith =>
      __$ButtonNetModelCopyWithImpl<_ButtonNetModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ButtonNetModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ButtonNetModelCopyWith<$Res>
    implements $ButtonNetModelCopyWith<$Res> {
  factory _$ButtonNetModelCopyWith(
          _ButtonNetModel value, $Res Function(_ButtonNetModel) _then) =
      __$ButtonNetModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
