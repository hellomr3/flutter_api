...
mixin _$ActivityListNetModel {
  ...
  $ActivityListNetModelCopyWith<ActivityListNetModel> get copyWith =>
      _$ActivityListNetModelCopyWithImpl<ActivityListNetModel>(
          this as ActivityListNetModel, _$identity);
...
abstract mixin class $ActivityListNetModelCopyWith<$Res> {
  factory $ActivityListNetModelCopyWith(ActivityListNetModel value,
          $Res Function(ActivityListNetModel) _then) =
      _$ActivityListNetModelCopyWithImpl;
  @useResult
  $Res call({List<ActivityNetModel>? lists});
}
...
extension ActivityListNetModelPatterns on ActivityListNetModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ActivityListNetModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<ActivityNetModel>? lists)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ActivityListNetModel() when $default != null:
        return $default(_that.lists);
      case _:
        return orElse();
    }
  }
...
class _ActivityListNetModel implements ActivityListNetModel {
  const _ActivityListNetModel({final List<ActivityNetModel>? lists})
      : _lists = lists;
  factory _ActivityListNetModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ActivityListNetModelCopyWith<_ActivityListNetModel> get copyWith =>
      __$ActivityListNetModelCopyWithImpl<_ActivityListNetModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ActivityListNetModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ActivityListNetModel &&
...
/// @nodoc
abstract mixin class _$ActivityListNetModelCopyWith<$Res>
    implements $ActivityListNetModelCopyWith<$Res> {
  factory _$ActivityListNetModelCopyWith(_ActivityListNetModel value,
          $Res Function(_ActivityListNetModel) _then) =
      __$ActivityListNetModelCopyWithImpl;
  @override
  @useResult
  $Res call({List<ActivityNetModel>? lists});
}
