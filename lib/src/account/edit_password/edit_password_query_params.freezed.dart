...
$EditPasswordQueryParamsCopyWith<EditPasswordQueryParams> get copyWith => _$EditPasswordQueryParamsCopyWithImpl<EditPasswordQueryParams>(this as EditPasswordQueryParams, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EditPasswordQueryParams&&(identical(other.oldPassword, oldPassword) || other.oldPassword == oldPassword)&&(identical(other.newPassword, newPassword) || other.newPassword == newPassword));
}
...
abstract mixin class $EditPasswordQueryParamsCopyWith<$Res>  {
  factory $EditPasswordQueryParamsCopyWith(EditPasswordQueryParams value, $Res Function(EditPasswordQueryParams) _then) = _$EditPasswordQueryParamsCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EditPasswordQueryParams value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EditPasswordQueryParams value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EditPasswordQueryParams value)?  $default,){
final _that = this;
switch (_that) {
case _EditPasswordQueryParams() when $default != null:
return $default(_that);case _:
...
class _EditPasswordQueryParams implements EditPasswordQueryParams {
  const _EditPasswordQueryParams({required this.oldPassword, required this.newPassword});
  factory _EditPasswordQueryParams.fromJson(Map<String, dynamic> json) => _$EditPasswordQueryParamsFromJson(json);
...
@pragma('vm:prefer-inline')
_$EditPasswordQueryParamsCopyWith<_EditPasswordQueryParams> get copyWith => __$EditPasswordQueryParamsCopyWithImpl<_EditPasswordQueryParams>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$EditPasswordQueryParamsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EditPasswordQueryParams&&(identical(other.oldPassword, oldPassword) || other.oldPassword == oldPassword)&&(identical(other.newPassword, newPassword) || other.newPassword == newPassword));
}
...
/// @nodoc
abstract mixin class _$EditPasswordQueryParamsCopyWith<$Res> implements $EditPasswordQueryParamsCopyWith<$Res> {
  factory _$EditPasswordQueryParamsCopyWith(_EditPasswordQueryParams value, $Res Function(_EditPasswordQueryParams) _then) = __$EditPasswordQueryParamsCopyWithImpl;
@override @useResult
$Res call({
 String oldPassword, String newPassword
});
