...
mixin _$EditNicknameQueryParams {
  ...
  $EditNicknameQueryParamsCopyWith<EditNicknameQueryParams> get copyWith =>
      _$EditNicknameQueryParamsCopyWithImpl<EditNicknameQueryParams>(
          this as EditNicknameQueryParams, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EditNicknameQueryParams &&
...
abstract mixin class $EditNicknameQueryParamsCopyWith<$Res> {
  factory $EditNicknameQueryParamsCopyWith(EditNicknameQueryParams value,
          $Res Function(EditNicknameQueryParams) _then) =
      _$EditNicknameQueryParamsCopyWithImpl;
  @useResult
...
extension EditNicknameQueryParamsPatterns on EditNicknameQueryParams {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_EditNicknameQueryParams value)? $default, {
...
class _EditNicknameQueryParams implements EditNicknameQueryParams {
  ...
  factory _EditNicknameQueryParams.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EditNicknameQueryParamsCopyWith<_EditNicknameQueryParams> get copyWith =>
      __$EditNicknameQueryParamsCopyWithImpl<_EditNicknameQueryParams>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EditNicknameQueryParamsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _EditNicknameQueryParams &&
            (identical(other.nickname, nickname) ||
                other.nickname == nickname));
  }
...
/// @nodoc
abstract mixin class _$EditNicknameQueryParamsCopyWith<$Res>
    implements $EditNicknameQueryParamsCopyWith<$Res> {
  factory _$EditNicknameQueryParamsCopyWith(_EditNicknameQueryParams value,
          $Res Function(_EditNicknameQueryParams) _then) =
      __$EditNicknameQueryParamsCopyWithImpl;
  @override
  @useResult
  $Res call({String nickname});
}
