...
class _AccountApi implements AccountApi {
  ...
  Future<ApiResponse<void>> editPassword(
    EditPasswordQueryParams request,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<ApiResponse<void>> editNickname(
    EditNicknameQueryParams request,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<ApiResponse<void>> editUsername(
    EditUsernameQueryParams request,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<ApiResponse<HwLoginResponse>> hwLogin(
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<ApiResponse<HwLoginResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/user/v1/hwLogin',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<HwLoginResponse> _value;
    try {
      _value = ApiResponse<HwLoginResponse>.fromJson(
        _result.data!,
        (json) => HwLoginResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
  ...
  Future<ApiResponse<WechatLoginResponse>> wechatLoginV2(
    WechatOperateParams request,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<ApiResponse<WechatLoginResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/user/v2/wechatLogin',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<WechatLoginResponse> _value;
    try {
      _value = ApiResponse<WechatLoginResponse>.fromJson(
        _result.data!,
  ...
  @override
  Future<ApiResponse<void>> bindWechat(WechatOperateParams request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
  ...
  @override
  Future<ApiResponse<void>> unbindWechat(WechatOperateParams request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
