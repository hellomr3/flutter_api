...
$EditUsernameQueryParamsCopyWith<EditUsernameQueryParams> get copyWith => _$EditUsernameQueryParamsCopyWithImpl<EditUsernameQueryParams>(this as EditUsernameQueryParams, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EditUsernameQueryParams&&(identical(other.username, username) || other.username == username));
}
...
abstract mixin class $EditUsernameQueryParamsCopyWith<$Res>  {
  factory $EditUsernameQueryParamsCopyWith(EditUsernameQueryParams value, $Res Function(EditUsernameQueryParams) _then) = _$EditUsernameQueryParamsCopyWithImpl;
@useResult
$Res call({
 String username
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EditUsernameQueryParams value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EditUsernameQueryParams value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EditUsernameQueryParams value)?  $default,){
final _that = this;
switch (_that) {
case _EditUsernameQueryParams() when $default != null:
return $default(_that);case _:
...
class _EditUsernameQueryParams implements EditUsernameQueryParams {
  ...
  factory _EditUsernameQueryParams.fromJson(Map<String, dynamic> json) => _$EditUsernameQueryParamsFromJson(json);
...
@pragma('vm:prefer-inline')
_$EditUsernameQueryParamsCopyWith<_EditUsernameQueryParams> get copyWith => __$EditUsernameQueryParamsCopyWithImpl<_EditUsernameQueryParams>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$EditUsernameQueryParamsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EditUsernameQueryParams&&(identical(other.username, username) || other.username == username));
}
...
/// @nodoc
abstract mixin class _$EditUsernameQueryParamsCopyWith<$Res> implements $EditUsernameQueryParamsCopyWith<$Res> {
  factory _$EditUsernameQueryParamsCopyWith(_EditUsernameQueryParams value, $Res Function(_EditUsernameQueryParams) _then) = __$EditUsernameQueryParamsCopyWithImpl;
@override @useResult
$Res call({
 String username
});
