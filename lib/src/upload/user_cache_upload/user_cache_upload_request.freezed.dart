...
mixin _$UserCacheUploadRequest {
  ...
  $UserCacheUploadRequestCopyWith<UserCacheUploadRequest> get copyWith =>
      _$UserCacheUploadRequestCopyWithImpl<UserCacheUploadRequest>(
          this as UserCacheUploadRequest, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UserCacheUploadRequest &&
...
abstract mixin class $UserCacheUploadRequestCopyWith<$Res> {
  factory $UserCacheUploadRequestCopyWith(UserCacheUploadRequest value,
          $Res Function(UserCacheUploadRequest) _then) =
      _$UserCacheUploadRequestCopyWithImpl;
  @useResult
  $Res call({@JsonKey(name: 'originalFilename') String originalFilename});
}
...
extension UserCacheUploadRequestPatterns on UserCacheUploadRequest {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UserCacheUploadRequest value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _UserCacheUploadRequest() when $default != null:
        return $default(_that.originalFilename);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(@JsonKey(name: 'originalFilename') String originalFilename)
        $default,
  ) {
    final _that = this;
    switch (_that) {
...
class _UserCacheUploadRequest implements UserCacheUploadRequest {
  const _UserCacheUploadRequest(
      {@JsonKey(name: 'originalFilename') required this.originalFilename});
  factory _UserCacheUploadRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UserCacheUploadRequestCopyWith<_UserCacheUploadRequest> get copyWith =>
      __$UserCacheUploadRequestCopyWithImpl<_UserCacheUploadRequest>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UserCacheUploadRequestToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UserCacheUploadRequest &&
            (identical(other.originalFilename, originalFilename) ||
                other.originalFilename == originalFilename));
  }
...
/// @nodoc
abstract mixin class _$UserCacheUploadRequestCopyWith<$Res>
    implements $UserCacheUploadRequestCopyWith<$Res> {
  factory _$UserCacheUploadRequestCopyWith(_UserCacheUploadRequest value,
          $Res Function(_UserCacheUploadRequest) _then) =
      __$UserCacheUploadRequestCopyWithImpl;
  @override
  @useResult
  $Res call({@JsonKey(name: 'originalFilename') String originalFilename});
}
