...
@JsonKey(name: 'presignedUrl') String get presignedUrl;@JsonKey(name: 'objectKey') String get objectKey;@JsonKey(name: 'accessUrl') String? get accessUrl;@JsonKey(name: 'expiration') int? get expiration;
...
@useResult
$Res call({
@JsonKey(name: 'presignedUrl') String presignedUrl,@JsonKey(name: 'objectKey') String objectKey,@JsonKey(name: 'accessUrl') String? accessUrl,@JsonKey(name: 'expiration') int? expiration
});
...
/// Create a copy of PresignedUploadResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? presignedUrl = null,Object? objectKey = null,Object? accessUrl = freezed,Object? expiration = freezed,}) {
...
as String,accessUrl: freezed == accessUrl ? _self.accessUrl : accessUrl // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'presignedUrl')  String presignedUrl, @JsonKey(name: 'objectKey')  String objectKey, @JsonKey(name: 'accessUrl')  String? accessUrl, @JsonKey(name: 'expiration')  int? expiration)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PresignedUploadResponse() when $default != null:
return $default(_that.presignedUrl,_that.objectKey,_that.accessUrl,_that.expiration);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'presignedUrl')  String presignedUrl, @JsonKey(name: 'objectKey')  String objectKey, @JsonKey(name: 'accessUrl')  String? accessUrl, @JsonKey(name: 'expiration')  int? expiration)  $default,) {final _that = this;
switch (_that) {
case _PresignedUploadResponse():
return $default(_that.presignedUrl,_that.objectKey,_that.accessUrl,_that.expiration);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'presignedUrl')  String presignedUrl, @JsonKey(name: 'objectKey')  String objectKey, @JsonKey(name: 'accessUrl')  String? accessUrl, @JsonKey(name: 'expiration')  int? expiration)?  $default,) {final _that = this;
switch (_that) {
case _PresignedUploadResponse() when $default != null:
return $default(_that.presignedUrl,_that.objectKey,_that.accessUrl,_that.expiration);case _:
  return null;
...
class _PresignedUploadResponse implements PresignedUploadResponse {
  const _PresignedUploadResponse({@JsonKey(name: 'presignedUrl') required this.presignedUrl, @JsonKey(name: 'objectKey') required this.objectKey, @JsonKey(name: 'accessUrl') this.accessUrl, @JsonKey(name: 'expiration') this.expiration});
  factory _PresignedUploadResponse.fromJson(Map<String, dynamic> json) => _$PresignedUploadResponseFromJson(json);

@override@JsonKey(name: 'presignedUrl') final  String presignedUrl;
@override@JsonKey(name: 'objectKey') final  String objectKey;
@override@JsonKey(name: 'accessUrl') final  String? accessUrl;
@override@JsonKey(name: 'expiration') final  int? expiration;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PresignedUploadResponse&&(identical(other.presignedUrl, presignedUrl) || other.presignedUrl == presignedUrl)&&(identical(other.objectKey, objectKey) || other.objectKey == objectKey)&&(identical(other.accessUrl, accessUrl) || other.accessUrl == accessUrl)&&(identical(other.expiration, expiration) || other.expiration == expiration));
}
...
/// Create a copy of PresignedUploadResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? presignedUrl = null,Object? objectKey = null,Object? accessUrl = freezed,Object? expiration = freezed,}) {
