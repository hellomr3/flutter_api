...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ApiList<T>&&const DeepCollectionEquality().equals(other.list, list));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ApiList<T> value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ApiList<T> value)  $default,){
final _that = this;
switch (_that) {
case _ApiList():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ApiList<T> value)?  $default,){
final _that = this;
switch (_that) {
case _ApiList() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<T> list)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiList() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<T> list)  $default,) {final _that = this;
switch (_that) {
case _ApiList():
return $default(_that.list);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<T> list)?  $default,) {final _that = this;
switch (_that) {
case _ApiList() when $default != null:
return $default(_that.list);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ApiList<T>&&const DeepCollectionEquality().equals(other._list, _list));
}
